defmodule DSBetWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-zinc-700/10 fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DSBetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DSBetWeb.Gettext, "errors", msg, opts)
    end
  end
